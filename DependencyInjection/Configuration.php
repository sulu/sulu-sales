    ...
    public function getConfigTreeBuilder()
    {
        ...
        $treeBuilder->root('sulu_sales_order')
            ...
            ->arrayNode('email_templates')
                ->addDefaultsIfNotSet()
                    ->children()
                    ->scalarNode('customer_confirmation')->defaultValue('SuluSalesOrderBundle:Email:customer.order.confirmation.twig')->end()
                    ->scalarNode('shopowner_confirmation')->defaultValue('SuluSalesOrderBundle:Email:shopowner.order.confirmation.twig')->end()
